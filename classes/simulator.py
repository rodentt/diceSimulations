...
class Simulator:
    ...
    def displayResult(self):
        ...
        def subtractArr(arr1, arr2):
            arr3 = [0] * self._numFaces
            i = 0
            for x in arr1:
                arr3[i] = abs(arr2[i] - x)
                i = i + 1
        ...
        rowHeaders = ["Expected", "Results", "Abs Diff."]
        measurementTable = [["Expected"] + self._expectedMeasures, ["Results"] + self._resultMeasures, ["Abs Diff."] + subtractArr(self._expectedMeasures, self._resultMeasures)]
